...
export const blueprint = {
 ...
 ['P101 · Semester 1','Role and credits confirmed; module-level outcome/boundary/workload map approved. Four blocks approved; complete 13-unit proposal and pair prerequisite check published.','Review P101 units and pair prerequisites, then move to M102. Calendar reconciliation remains pending. Allocate required computing and measurement foundations even for learners who do not take M100.'],
