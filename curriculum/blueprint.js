...
export const blueprint = {
 ...
 ['M101 · Semester 1','Role and credits confirmed; module-level outcome/boundary/workload map proposed. Blocks and units absent.','After review of the Stage 1 peer map, first module for detailed blueprint review: outcomes, blocks, all units, hours, assessment and P101 dependencies.'],
 ['P101 · Semester 1','Role and credits confirmed; module-level outcome/boundary/workload map proposed. Blocks and units absent.','Define after the first M101 proposal; reconcile the pair before approval. Allocate required computing and measurement foundations even for learners who do not take M100.'],
 ['M102 · Semester 2','Role and credits confirmed; module-level outcome/boundary/workload map proposed. Blocks and units absent.','Define mathematical progression from M101 and co-requisites needed by A101 and Stage 2.'],
 ['A101 · Semester 2','Ten provisional units; module-level handovers and boundaries now proposed for review. 240 unit hours plus 60 other hours; no defined blocks.','Review inherited scopes for Semester 2 depth, add blocks, replace general entry statements with outcome-level dependencies and reconcile with M102.'],
