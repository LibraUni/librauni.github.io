...
export const blueprint = {
 ...
 ['M101 · Semester 1','Module role and 30-credit allocation confirmed; blocks and units absent.','First module for detailed blueprint review: outcomes, blocks, all units, hours, assessment and P101 dependencies.'],
 ['P101 · Semester 1','Module role and 30-credit allocation confirmed; blocks and units absent.','Define after the first M101 proposal; reconcile the pair before approval. Allocate required computing and measurement foundations even for learners who do not take M100.'],
 ['M102 · Semester 2','Module role and 30-credit allocation confirmed; blocks and units absent.','Define mathematical progression from M101 and co-requisites needed by A101 and Stage 2.'],
 ['A101 · Semester 2','Ten provisional units and draft assessment; 240 unit hours plus 60 other hours. No defined blocks.','Review inherited scopes for Semester 2 depth, add blocks, replace general entry statements with outcome-level dependencies and reconcile with M102.'],
