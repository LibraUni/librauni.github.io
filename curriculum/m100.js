...
export const m100 = {
  ...
  units: [
    ...
    {id:'U06',title:'Functions, transformations & inverse relationships',hours:22,requires:['U03','U05'],outcomes:['O2','O3','O6','O7'],
    ...
    {id:'U08',title:'Geometry, angles & trigonometric relationships',hours:28,requires:['U02','U06','U07'],outcomes:['O3','O4','O5','O6','O7'],
      ...
      boundary:'Advanced identities, complex-exponential representations and calculus of trig functions are deferred. The approved 28-hour allocation gives this dense unit more practice; observed timing still needs review.'},
  ...
  additionalWork: [
    {name:'Orientation and study/computing setup',hours:6,detail:'Six guided hours: VS Code/Python/Jupyter setup and troubleshooting (3h); first notebook, cells, kernel, save/reopen/restart-and-run and file backup practice (1h); study navigation and file organisation (1h); initial non-graded readiness conversation/sample (1h). Assume only very basic Python familiarity; explain each setup step. U01 then teaches variables, types, operators and errors within its existing four Python hours. These are included hours, not extra workload; additional troubleshooting time is recorded explicitly. No diagnostic is administered by this preview.'},
