...
export const modules=[{
 ...
 scheduleVersion:2,weeks:30,enrollable:false,
 ...
 events:[
  ...
  {...assessment('EMA-FINAL','EMA · Written mathematics, notebook and explanation','EMA',29,30,18,m101.units.map(u=>u.id),'One end-of-module assessment with a single deadline at the end of week 30. A: independent Python modelling notebook (10 hours). B: handwritten mathematics (4 hours) plus scanning/checking the PDF (1 hour). C: notebook interpretation (2 hours) and tutor discussion (1 hour). The 18 hours are work budgets, not a separate timed examination. Submission arrangements and allowed support will be specified before release.'),weeklyHours:{29:10,30:8}},
