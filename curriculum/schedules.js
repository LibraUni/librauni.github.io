...
export const modules=[{
 code:m101.code,title:m101.title,path:'/programme/stage-1/lu-m101/',credits:30,
 scheduleVersion:1,weeks:30,enrollable:false,
 ...
 events:[
  ...
  ...m101.units.map((u,i)=>({...u,type:'unit',startWeek:ranges[i][0],endWeek:ranges[i][1],description:u.scope,available:false,outline:'#'+u.id})),
  ...
  assessment('EMA01','EMA · Independent modelling notebook','EMA',29,29,10,['U11','U12'],'End-of-module assessment: an independent Python notebook and explanation, separate from guided unit practice.'),
  assessment('EXAM','Final examination & follow-up','exam',30,30,8,m101.units.map(u=>u.id),'Five-hour written component budget: four hours of handwritten work and one hour to scan, check legibility/order and submit a PDF. A further two hours cover notebook interpretation and one hour a tutor discussion. Exact sitting arrangements and allowed aids will be agreed before release.'),
