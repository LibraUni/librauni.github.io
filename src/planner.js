...
function render(){
 ...
 <p><a href="/programme/#degree-calendar">Degree calendar →</a></p><p><strong>${module.weeks} study weeks · ${module.credits*10} hours · ${(module.credits*10/module.weeks).toFixed(1)} hours/week on average.</strong> Workload varies by week. Your original timetable remains visible after personal changes.</p>
